...
def parse_arguments():
    ...
    parser.add_argument('--label', type=int, default=False, help='whether test data accompanies with label')
    ...
    parser.add_argument('--shapename', type=str, default='new1{i}', help='shape to evaluate format : name{i}')
